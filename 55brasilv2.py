...
casosmean = casos
#casosmean = np.append(casosmean, [0.1, 0.1])
...
classification_result_humi = classify_distribution(humiclas)
humicasos = np.char.add(classification_result_humi, classification_result_casos)

classification_result_rh = classify_distribution(rhclas)
...
plt.yticks(np.arange(1, 5, 1), labels=[np.round(min_valuetemp + (range_valuestemp / 5),2), np.round(min_valuetemp + (2*range_valuestemp / 5),2),np.round(min_valuetemp + 3*(range_valuestemp / 5),2),np.round(min_valuetemp + 4*(range_valuestemp / 5),2)])  # Label y-axis (temperature, inverted)
plt.xlabel("Casos (?)")
plt.ylabel("Temperatura (C)")
#nameoffigure = "bivariate_colorbar55_temp_arbov"
nameoffigure = "bivariate_colorbar55_temp_ivas"
string_in_string = "{}".format(nameoffigure)
plt.savefig(figsdir+string_in_string,dpi=100)
...
#nameoffigure = "bivariate_colorbar55_rh_arbov"
nameoffigure = "bivariate_colorbar55_rh_ivas"
string_in_string = "{}".format(nameoffigure)
plt.savefig(figsdir+string_in_string,dpi=100)
...
#nameoffigure = "bivariate_colorbar55_precip_arbov"
nameoffigure = "bivariate_colorbar55_precip_ivas"
string_in_string = "{}".format(nameoffigure)
plt.savefig(figsdir+string_in_string,dpi=100)
...
# Save
#plt.savefig(figsdir + "55casos_temp_brasil_arbov.png", dpi=700, bbox_inches='tight')
plt.savefig(figsdir + "55casos_temp_brasil_ivas.png", dpi=700, bbox_inches='tight')
plt.close()
...
# Save
#plt.savefig(figsdir + "55casos_rh_brasil_arbov.png", dpi=700, bbox_inches='tight')
plt.savefig(figsdir + "55casos_rh_brasil_ivas.png", dpi=700, bbox_inches='tight')
plt.close()
...
# Save
#plt.savefig(figsdir + "55casos_precip_brasil_arbov.png", dpi=700, bbox_inches='tight')
plt.savefig(figsdir + "55casos_precip_brasil_ivas.png", dpi=700, bbox_inches='tight')
plt.close()
