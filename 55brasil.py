...
#meanhumi = np.nanmean(humi[51:],axis=(0))*365*24*100
#meanrh = np.nanmean(rh[51:],axis=(0))
...
with open('/home/numa23/Public/aesop/colors_blend.pickle', 'wb') as handle:
...
# Save
plt.savefig(figsdir + "55casos_temp_brasil.png", dpi=700, bbox_inches='tight')
plt.close()
