...
def classify_distribution(values):
    ...
    threshold1 = min_value + (range_values / 4)  # 1/4 of the range
    threshold2 = min_value + (2 * range_values / 4)  # 2/4 of the range
    threshold3 = min_value + (3 * range_values / 4)  # 3/4 of the range
    
    # Classify each value
    classification = np.where(flattened_values < threshold1, '1',
                              np.where(flattened_values < threshold2, '2',
                                      np.where(flattened_values < threshold3, '3', '4')))
...
fig = plt.figure()
plt.imshow(rgb_image, extent=[0, 4, 0, 4])  # 4x4 grid
plt.xticks(np.arange(1, 4, 1), labels=[int(min_valuehumi + (range_valueshumi / 4)),int(min_valuehumi + (2*range_valueshumi / 4)),int(min_valuehumi + 3*(range_valueshumi / 4))])  # Label x-axis (precipitation)
plt.yticks(np.arange(1, 4, 1), labels=[int(min_valuetemp + (range_valuestemp / 4)), int(min_valuetemp + (2*range_valuestemp / 4)),int(min_valuetemp + 3*(range_valuestemp / 4))])  # Label y-axis (temperature, inverted)
...
plt.xlabel("Precipitacao (mm)")
plt.ylabel("Temperatura (C)")
nameoffigure = "bivariate_colorbar_verao44"
string_in_string = "{}".format(nameoffigure)
plt.savefig(figsdir+string_in_string,dpi=100)
...
plt.xlabel("Precipitacao (mm)")
plt.ylabel("Temperatura (C)")
nameoffigure = "bivariate_colorbar_outono44"
string_in_string = "{}".format(nameoffigure)
plt.savefig(figsdir+string_in_string,dpi=100)
...
plt.xlabel("Precipitacao (mm)")
plt.ylabel("Temperatura (C)")
nameoffigure = "bivariate_colorbar_inverno44"
string_in_string = "{}".format(nameoffigure)
plt.savefig(figsdir+string_in_string,dpi=100)
...
plt.xlabel("Precipitacao (mm)")
plt.ylabel("Temperatura (C)")
nameoffigure = "bivariate_colorbar_primavera44"
string_in_string = "{}".format(nameoffigure)
plt.savefig(figsdir+string_in_string,dpi=100)
...
#Agora, vamoes plotar as estacoes de novo porem usando a colorbar para o ano inteiro

classification_result_veraotemp = classify_distribution3(veraotemp,temp)

classification_result_veraohumi = classify_distribution3(veraohumi,humi)

veraotemphumi = np.char.add(classification_result_veraotemp, classification_result_veraohumi)


classification_result_outonotemp = classify_distribution3(outonotemp,temp)

classification_result_outonohumi = classify_distribution3(outonohumi,humi)

outonotemphumi = np.char.add(classification_result_outonotemp, classification_result_outonohumi)



classification_result_invernotemp = classify_distribution3(invernotemp,temp)

classification_result_invernohumi = classify_distribution3(invernohumi,humi)

invernotemphumi = np.char.add(classification_result_invernotemp, classification_result_invernohumi)



classification_result_primaveratemp = classify_distribution3(primaveratemp,temp)


classification_result_primaverahumi = classify_distribution3(primaverahumi,humi)
...
im = ax.imshow(colors_blend[::-1,:], extent=(-55, -35, -30, 9), transform=ccrs.PlateCarree(), origin='lower')
plt.subplots_adjust(bottom=0.05, top=0.96, hspace=0.4,right=0.99,left=0.01)
nameoffigure = "plot_fig_brasil_verao44_colorbar2"
string_in_string = "{}".format(nameoffigure)
plt.savefig(figsdir+string_in_string,dpi=100)
...
im = ax.imshow(colors_blend[::-1,:], extent=(-55, -35, -30, 9), transform=ccrs.PlateCarree(), origin='lower')
plt.subplots_adjust(bottom=0.05, top=0.96, hspace=0.4,right=0.99,left=0.01)
nameoffigure = "plot_fig_brasil_outono44_colorbar2"
string_in_string = "{}".format(nameoffigure)
plt.savefig(figsdir+string_in_string,dpi=100)
...
im = ax.imshow(colors_blend[::-1,:], extent=(-55, -35, -30, 9), transform=ccrs.PlateCarree(), origin='lower')
plt.subplots_adjust(bottom=0.05, top=0.96, hspace=0.4,right=0.99,left=0.01)
nameoffigure = "plot_fig_brasil_inverno44_colorbar2"
string_in_string = "{}".format(nameoffigure)
plt.savefig(figsdir+string_in_string,dpi=100)
...
im = ax.imshow(colors_blend[::-1,:], extent=(-55, -35, -30, 9), transform=ccrs.PlateCarree(), origin='lower')
plt.subplots_adjust(bottom=0.05, top=0.96, hspace=0.4,right=0.99,left=0.01)
nameoffigure = "plot_fig_brasil_primavera44_colorbar2"
string_in_string = "{}".format(nameoffigure)
plt.savefig(figsdir+string_in_string,dpi=100)
