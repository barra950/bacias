...
filelocation = '/home/numa23/copernicus/br/'
shapefile_br = "/home/numa23/copernicus/Lim_america_do_sul_IBGE_2021" #Estados brasileiros
...
intervalos = ['Todas as áreas', 'Margem Norte', 'Bca. Santos', 'Bca. Campos']
...
dt = 29
intervalos = ['1940-1969', '1950-1979', '1960-1989', '1970-1999', '1980-2009', '1990-2019', '2000-2023']
skew = []

fig, ax = plt.subplots()

for tt in range(1940, 2001, 10):
...
intervalos = ['1943-1972', '1953-1982', '1963-1992', '1973-2002', '1983-2012', '1993-2022']

fig, ax = plt.subplots()

vento_clim = vento100.loc['1943':'1973'][:-3]
# mean
...
vento_clim = vento100.loc['1953':'1983'][:-3]
# mean
mean = vento_clim.mean()
# variance
var = vento_clim.var()
...
vento_clim = vento100.loc['1963':'1993'][:-3]
# mean
mean = vento_clim.mean()
# variance
var = vento_clim.var()
...
vento_clim = vento100.loc['1973':'2003'][:-3]
# mean
mean = vento_clim.mean()
# variance
var = vento_clim.var()
...
vento_clim = vento100.loc['1983':'2013'][:-3]
# mean
mean = vento_clim.mean()
# variance
var = vento_clim.var()
...
vento_clim = vento100.loc['1993':'2023'][:-3]
# mean
mean = vento_clim.mean()
# variance
var = vento_clim.var()
...
intervalos = ['1993-2022', '1993-2002', '2003-2012', '2013-2022']
...
vento_clim = vento100.loc['1993':'2003'][:-3]
# mean
mean = vento_clim.mean()
print(mean,'mean')
# variance
...
vento_clim = vento100.loc['2003':'2013'][:-3]
# mean
mean = vento_clim.mean()
# variance
var = vento_clim.var()
...
vento_clim = vento100.loc['2013':'2023'][:-3]
# mean
mean = vento_clim.mean()
# variance
var = vento_clim.var()
...
mag_ultimos30 = vento100.loc['1993':'2023'][:-3]

diff_mag_ultimos30 = []
for tt in range(1993, 2023):
    exec(f'diff_mag_ultimos30.append(mag_ultimos30.loc[str({tt})].mean() - mag_ultimos30.mean())')

time_30y = np.linspace(1993, 2022, 30)
...
intervalos = list(range(1993,2023,1))
